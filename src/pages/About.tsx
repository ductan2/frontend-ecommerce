                           ...
                           <div className="col-lg-6">
                              <div className="pl-25">
                                 ...
                                 <div className="carausel-3-columns-cover position-relative">
                                    <div id="carausel-3-columns-arrows"><span className="slider-btn slider-prev slick-arrow" ><i className="fi-rs-arrow-small-right"></i></span></div>
                                    <div className="carausel-3-columns slick-initialized slick-slider" id="carausel-3-columns">




                                       <div className="slick-list draggable"><div className="slick-track" style={{ opacity: "1", width: "1672px", transform: "translate3d(-760px, 0px, 0px)" }}>
                                          <img src="assets/imgs/page/about-3.png" alt="" className="slick-slide slick-cloned" tabIndex={-1} style={{ width: "128px" }} data-slick-index="-3" id="" aria-hidden="true" />
                                          <img src="assets/imgs/page/about-4.png" alt="" className="slick-slide slick-cloned" tabIndex={-1} style={{ width: "128px" }} data-slick-index="-2" id="" aria-hidden="true" />
                                          <img src="assets/imgs/page/about-2.png" alt="" className="slick-slide slick-cloned" tabIndex={-1} style={{ width: "128px" }} data-slick-index="-1" id="" aria-hidden="true" />
                                          <img src="assets/imgs/page/about-2.png" alt="" className="slick-slide" tabIndex={-1} style={{ width: "128px" }} data-slick-index="0" aria-hidden="true" />
                                          <img src="assets/imgs/page/about-3.png" alt="" className="slick-slide" tabIndex={-1} style={{ width: "128px" }} data-slick-index="1" aria-hidden="true" />
                                          <img src="assets/imgs/page/about-4.png" alt="" className="slick-slide slick-current slick-active" tabIndex={-1} style={{ width: "128px" }} data-slick-index="2" aria-hidden="false" />
                                          <img src="assets/imgs/page/about-2.png" alt="" className="slick-slide slick-active" tabIndex={0} style={{ width: "128px" }} data-slick-index="3" aria-hidden="false" />
                                          <img src="assets/imgs/page/about-2.png" alt="" className="slick-slide slick-cloned slick-active" tabIndex={-1} style={{ width: "128px" }} data-slick-index="4" id="" aria-hidden="false" />
                                          <img src="assets/imgs/page/about-3.png" alt="" className="slick-slide slick-cloned" tabIndex={-1} style={{ width: "128px" }} data-slick-index="5" id="" aria-hidden="true" />
                                          <img src="assets/imgs/page/about-4.png" alt="" className="slick-slide slick-cloned" tabIndex={-1} style={{ width: "128px" }} data-slick-index="6" id="" aria-hidden="true" />
                                          <img src="assets/imgs/page/about-2.png" alt="" className="slick-slide slick-cloned" tabIndex={-1} style={{ width: "128px" }} data-slick-index="7" id="" aria-hidden="true" />
                                       </div>
                                       </div>
                                    </div>
                                 </div>
